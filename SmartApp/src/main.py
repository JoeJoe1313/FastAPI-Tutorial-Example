# contains the code which will start the uvicorn server
# conatins the code to serve a request and return a response asynchronously
# create an instance of FastAPI() which is the main point of interaction to create the API
import uvicorn
...
app = FastAPI(
    ...
    description='A Smart Data Sceince Application running on FastAPI + uvicorn',
    version='0.0.1'
)
