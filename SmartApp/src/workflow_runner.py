# contains the code that will scrape the web pages and return the company names
# this is our data science application code which we are going to expose via FastAPI
# the core of our DS app
